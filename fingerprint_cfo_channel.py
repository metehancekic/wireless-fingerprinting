...
def multiple_day_fingerprint(architecture, config, num_days, seed_days):
	...
	#-------------------------------------------------
	equalize_train_before = True
	equalize_test_before = True
...
if __name__=='__main__':
	...
	_ = multiple_day_fingerprint(architecture, config, num_days=config['phy_method'], seed_days=config['seed_phy_train'])
