...
def train(dict_data, num_aug_test=1, checkpoint_in=None, checkpoint_out=None, batch_size=100, epochs=200):
	...
	if checkpoint_in is None:
		...
		output, model_name = network_200_shared_modrelu_parallelnetworks(data_input, num_classes, weight_decay)

		# output, model_name = network_200_shared_modrelu_early_abs(data_input, num_classes, weight_decay)

		# output, model_name = network_200_shared_modrelu_short_conv(data_input, num_classes, weight_decay)
	...
	plot_model(densenet, to_file='model_plot.png', show_shapes=True, show_layer_names=True)
...
def train_20(dict_data, num_aug_test=1, checkpoint_in=None, checkpoint_out=None, batch_size=100, epochs=200):
	...
	if checkpoint_in is None:
		...
		# output, model_name = network_20_wifi2(data_input, num_classes, weight_decay)
...
def train_200(dict_data, num_aug_test=1, 
						 checkpoint_in=None, 
						 checkpoint_out=None, 
						 batch_size=100, 
						 epochs=200,
