...
for NumAug in range(1,11):
	for experiment_i in range(5):

		seed_days =  [0 + experiment_i*400, 20 + experiment_i*400, 40 + experiment_i*400, 80 + experiment_i*400, 100 + experiment_i*400, 120 + experiment_i*400, 140 + experiment_i*400, 160 + experiment_i*400, 180 + experiment_i*400, 200 + experiment_i*400, 220 + experiment_i*400, 240 + experiment_i*400, 260 + experiment_i*400, 280 + experiment_i*400, 300 + experiment_i*400, 320 + experiment_i*400, 340 + experiment_i*400, 360 + experiment_i*400, 380 + experiment_i*400, 400 + experiment_i*400]
		...
		with open(exp_dir + '/logs-' + 'multi_days_cfo_wrt_aug_both_no_comp'  + '.txt', 'a+') as f:
